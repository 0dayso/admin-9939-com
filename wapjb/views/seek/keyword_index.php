...
?>
<?php
    $this->title=$key."相关疾病查询,".$key."相关症状查询";
?>
...
<!--症状1板块-->
<article class="sexn">
    <a <?php if($tab==''){echo 'class="curr"';}?> href="/jbzz/?key=<?php echo $key?>" />全部</a>
    <a <?php if($tab=='t1'){echo 'class="curr"';}?> href="/jbzz_t1/?key=<?php echo $key?>" />疾病</a>
    <a <?php if($tab=='t2'){echo 'class="curr"';}?>style="width:33.4%;" href="/jbzz_t2/?key=<?php echo $key?>" />症状</a>
</article>
<script>
$(function(){
    $(".sexn a").unbind( "click");
            ...
            <li>
                <h3><b class="ac_01">病</b>
                    <p>
                        ...
                        <?php 
                            echo $short_title = preg_replace("'({$explain_words})'","<font style='color:red;'>$0</font>",$res['name'])
                        ?>
                        </a>
