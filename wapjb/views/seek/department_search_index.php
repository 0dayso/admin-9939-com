...
?>
<article class="head"><a href="/"></a><span>按科室查找</span><a href="/jbzz/" class="setn"></a><a class="clna"></a></article>
<!--导航栏展开-->
<?php
...
<article class="clsa">
    <?php
        foreach($departmentLevel1 as $k=>$depart){
    ?>
...
<!--症状1板块-->
<article class="sexn">
    <a <?php if($tab==''){echo 'class="curr"';}?> href="/jbzz/keshi/" />全部</a>
<a <?php if($tab=='t1'){echo 'class="curr"';}?> href="/jbzz/keshi_t1/" />疾病</a>
    <a <?php if($tab=='t2'){echo 'class="curr"';}?>style="width:33.4%;" href="/jbzz/keshi_t2/" />症状</a>
</article>
<script>
$(function(){
    $(".sexn a").unbind( "click");
    ...
    <section class="sechoi">
    	<ul class="ache">
            ...
            <li>
                <h3>
                    <b class="ac_02">症</b>
                    <p><a href="/zhengzhuang/<?php echo $res['pinyin_initial'];?>/"><?php echo $res['name'];?></a><span>（别名：<?php echo $res['alias'];?>）</span></p>
                </h3>
                <div class="simg">
