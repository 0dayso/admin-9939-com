...
<h2 class="hepla heanew clearfix">
    <b><i><?php echo $partlevel1['name'];?></i><span class="nela"></span></b>
    <dl class="find">
...
<article class="clsa">
    <?php
        foreach($partlevel2List as $k=>$level2){
    ?>
    <a href="/jbzz/<?php echo $level2['pinyin'];?>/" <?php if($partlevel2['name']==$level2['name']){echo'class="cus"';}?>><?php echo $level2['name'];?></a>
    <?php
        }
    ?>
    <!--<a class="cus">耳</a>-->
...
<div class="choico disn">
    <h3>请选择其它部位</h3>
    <?php
        foreach ($partlevel1List as $k1=>$level1){
    ?>
    <a href="/jbzz/<?php echo $level1['pinyin'];?>/" <?php if($partlevel1['name'] == $level1['name']){echo 'class="cmb"';}?>><?php echo $level1['name']; ?></a>
    <?php
        }
    ?>
    <!--<a class="cmb" href="">颈部</a>-->
</div>
