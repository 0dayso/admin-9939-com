...
<article class="bocon compl shagin">
    <h3><?php echo $model['name'];?><span>食疗</span></h3>
    <p>宜吃饮食<br/>
        <?php echo $model['content']['goodfood']?>
    </p>

<article class="deserv"></article>

<p>忌吃饮食<br/>
   <?php echo $model['content']['badfood']?>
</p>

<article class="deserv"></article>
<a class="shic">分享</a>
</article>
<a href="" class="fimor resea aret">返回症状<span>&gt;</span></a>
<div class="thre"></div>
<h2>症状相关</h2>
