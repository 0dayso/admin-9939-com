...
$this->params['keywords'] = "${diseaseName}的病因,${diseaseName}的原因,${diseaseName}是怎么引起的";
$this->params['description'] = "久久健康网-疾病百科频道提供专业、全面的${diseaseName}的病因、${diseaseName}的原因、${diseaseName}是怎么引起的疾病百科知识、查询疾病方便、快捷、深受网民喜爱！";
...
<article class="bocon compl shagin diacl usymt">
    <h3><?php echo $disease['name']; ?><span>预防</span></h3>
    <p class="inde"><?php echo str_replace(PHP_EOL, "</p><p style='text-indent:2em'>", $disease['cause']); ?></p>
    <a class="shic">分享</a>
</article>
<!--分享-->
