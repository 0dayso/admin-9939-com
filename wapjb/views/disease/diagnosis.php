...
$this->params['keywords'] = "${diseaseName}鉴别诊断,如何鉴别${diseaseName}";
$this->params['description'] = "久久健康网-疾病百科频道提供专业、全面的${diseaseName}鉴别诊断、如何鉴别${diseaseName}等疾病百科知识、查询疾病方便、快捷、深受网民喜爱！";
...
<article class="bocon compl shagin diacl usymt">
    ...
    <p class="inde"><?php echo str_replace(PHP_EOL, "</p><p style='text-indent:2em'>", $disease['diagnosis']); ?></p>
    <a class="shic">分享</a>
</article>
<!--分享-->
