...
$this->params['keywords'] = "${diseaseName}预防,如何预防${diseaseName},预防${diseaseName}的措施";
$this->params['description'] = "久久健康网-疾病百科频道提供专业、全面的${diseaseName}预防、如何预防${diseaseName}、预防${diseaseName}的措施等疾病百科知识、查询疾病方便、快捷、深受网民喜爱！";
...
<article class="bocon compl shagin diacl usymt">
    ...
    <p class="inde"><?php echo str_replace(PHP_EOL, "</p><p style='text-indent:2em'>", $disease['prevent']); ?></p>
    <a class="shic">分享</a>
</article>
<!--分享-->
