...
$this->params['keywords'] = "${diseaseName}并发症,${diseaseName}会引起什么病,${diseaseName}后遗症";
$this->params['description'] = "久久健康网-疾病百科频道提供专业、全面的${diseaseName}并发症、${diseaseName}会引起什么病、${diseaseName}后遗症等疾病百科知识、查询疾病方便、快捷、深受网民喜爱！";
...
<article class="bocon compl shagin diacl usymt">
    <h3><?php echo $disease['name']; ?><span>可能并发哪些疾病？</span></h3>
    <p class="inde"><?php echo str_replace(PHP_EOL, "</p><p style='text-indent:2em'>", $disease['neopathy']); ?></p>
    <a class="shic">分享</a>
</article>
<!--分享-->
