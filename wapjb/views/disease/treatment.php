...
$this->params['keywords'] = "${diseaseName}的治疗方法,${diseaseName}怎么办,${diseaseName}治愈,${diseaseName}用药";
$this->params['description'] = "久久健康网-疾病百科频道提供专业、全面的${diseaseName}的治疗方法、${diseaseName}怎么办、${diseaseName}治愈、${diseaseName}用药等疾病百科知识、查询疾病方便、快捷、深受网民喜爱！";
...
<article class="bocon compl shagin diacl usymt">
    ...
    <h4>治疗方式</h4>
    <p class="inde"><?php echo $disease['treatment']; ?></p>
    <h4>治疗内容</h4>
    <p class="inde"><?php echo str_replace(PHP_EOL, "</p><p style='text-indent:2em'>", $disease['treat']); ?></p>
    <a class="shic">分享</a>
</article>
<!--分享-->
