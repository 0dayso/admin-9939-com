...
//        }
        ...
        <link rel="stylesheet" type="text/css" href="<?php echo Url::to('@jb_domain/css/main.css?123456') ?>"/>
        <link rel="stylesheet" type="text/css" href="<?php echo Url::to('@jb_domain/css/list.css?20160909') ?>"/>
        ...
        <script type="text/javascript" src="<?php echo Url::to('@jb_domain/js/detail.js?20160909') ?>"></script>
        <base target="_blank">
    <?php $this->head(); ?>
    </head>
    <?= $this->beginBody() ?>
