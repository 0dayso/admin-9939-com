...
//        $sphinx = new Sphinx(array('servers'=>[['host'=>'192.168.28.50','port'=>9312]]));
//        return $sphinx;
     ...
     */
    public static function Search_batch($keyword, $indexer, $offset, $size,array $conditions = array(),$explainflag=1){
    	$search = self::Q();
    ...
    public static function batchSearch($queries = array()){
        ...
        foreach($queries as $k=>$v){
            ...
            if(!empty($kw)){
                ...
                if($explainflag===1){
                    $search->SetMatchMode(SPH_MATCH_EXTENDED2);
                    $keywords = self::explainWords($keywords);
                }
