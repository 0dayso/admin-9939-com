 ...
 * @returns {Boolean}
 */
function search(cache, action, type, pagenum){
//    console.log(type);
    if(cache == 0){
        if(type==undefined || type==null){
            type = 'unshow';
        }
        var articleid = $(".disin #articleid").val()=='' ? 0 : $(".disin #articleid").val();
        var title = $(".disin #title").val()=='' ? 0 : $(".disin #title").val();
        var diseasename = $(".disin #diseasename").val()=='' ? 0 : $(".disin #diseasename").val();
        var inputtime_begin = $(".disin #inputtime_begin").val()=='' ? 0 : $(".disin #inputtime_begin").val();
        var inputtime_end = $(".disin #inputtime_end").val()=='' ? 0 : $(".disin #inputtime_end").val();
        var username = $(".disin #username").val()=='' ? 0 : $(".disin #username").val();
        
        var status = $(".disin #status").val()=='' ? 0 : $(".disin #status").val();
        var page = $(".paget .curt").html();
//        console.log(page);
//        return false;
