                    ...
                    <tbody>
                        <tr bgcolor="#FFFFFF"> 
                            ...
                            <td style="padding-top:10px;">
                                <div class="col-md-9">
                                    <input type="text" id="role[role_name]" name="role[role_name]" size="30" placeholder="请输入角色名称" class="form-control"/>
                        ...
                        <tr bgcolor="#FFFFFF"> 
                            ...
                            <td style="padding-top:10px;">
                                <div class="col-md-9">
                                    <textarea id="role[remark]" name="role[remark]" class="form-control span7"></textarea>
                                </div>
                            </td>
                        </tr>
                        <tr> 
                                ...
                                <table border="0" cellpadding="3" cellspacing="1" width="100%" style="margin-top:0;">
                                    <tbody>
                                        <tr>
                                            <td>
                                                <p class="tocho">
                                                    <input type="checkbox" id="cbx_func_group_all" name="cbx_func_group_all"  data-func-id="0"  data-func-fatherid="0" class="cbx_func_group_all">全选
                                                </p>
                                            </td>
                                        </tr>
                                        <tr>
                                                        ...
                                                        <?php $group_index = 1; foreach($funcData as $k=>$v){ ?> 
                                                            ...
                                                            <tr> 
                                                                <td bgcolor="#FFFFFF" width="90%" style=" border-bottom:none;">
                                                                    <ul class="menu">
                                                                        <li><input type="checkbox"  id="cbx_func_item_<?php echo $v['id']; ?>" name="cbx_func_item_<?php echo $v['id']; ?>" data-func-id="<?php echo $v['id']; ?>" data-func-group-index="<?php echo $group_index; ?>" class="css_cbx css_func_item"  value="<?php echo $v['id']; ?>" ><?php echo $v['name'].'首页'; ?></li>
                                                                        <?php $cfuncs = $v['children']; ?>
                                                                        <?php foreach($cfuncs as $kk=>$vv) { ?>
                                                                            <li><input type="checkbox" id="cbx_func_item_<?php echo $vv['id']; ?>" name="cbx_func_item_<?php echo $vv['id']; ?>" data-func-id="<?php echo $vv['id']; ?>" data-func-group-index="<?php echo $group_index; ?>" class="css_cbx css_func_item"  value="<?php echo $vv['id']; ?>"><?php echo $vv['name']; ?></li>
                                                                        <?php } ?>
                                                                    </ul>
