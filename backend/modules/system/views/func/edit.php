            ...
            <form id="addFuncForm" name="addModulesForm" action="<?php echo Url::toRoute('func/save'); ?>" method="post" class="form-horizontal"
                ...
                <div class="form-body">
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <input type="text" id="func[caption]" name="func[caption]" size="30" placeholder="请输入功能名称" value="<?php echo $funcInfo['caption'];?>"
                                   class="form-control"/>
                        </div>
                    </div>
                    <div class="form-group">
                            ...
                            <select name="func[parent_id]" id="func[parent_id]" class="form-control">
                                ...
                                <optgroup label="功能列表">
                                    <?php foreach ($funcList as $func) { ?>
                                        <option value="<?php echo $func['id']?>" <?php echo $funcInfo['parent_id'] == $func['id']?"selected":""?>>⊕ <?php echo $func['caption']?></option>
                                    <?php } ?>
                                </optgroup>
                            </select>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <input id="func[moduleid]" name="func[moduleid]" size="50" type="text" placeholder="请输入模块id" value="<?php echo $funcInfo['moduleid'];?>"
                                   class="form-control"/>
                                                    <span>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <input id="func[controllerid]" name="func[controllerid]" size="50" type="text" placeholder="请输入控制器id"  value="<?php echo $funcInfo['controllerid'];?>"
                                   class="form-control"/>
                                                    <span>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <input id="func[url]" name="func[url]" size="50" type="text" placeholder="请输入功能链接" value="<?php echo $funcInfo['url'];?>"
                                   class="form-control"/>
                                                    <span>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <input type="text" id="func[order_by]" name="func[order_by]" value="<?php echo $funcInfo['order_by'];?>" class="form-control">
                            <span>注:正序排列 </span>
                        </div>
                    </div>
                    ...
                    <div class="form-group last">
                        ...
                        <div class="col-md-9">
                            <textarea rows="5" name="func[remark]" id="func[remark]" class="form-control  span7"><?php echo $funcInfo['remark'];?></textarea>
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        <label class="checkbox inline">
                            <input type="radio" value="1" name="func[status]" <?php echo $funcInfo['status']==1?"checked":""?> > 显示
                        </label>
                        <label class="checkbox inline">
                            <input type="radio" value="0" name="func[status]" <?php echo $funcInfo['status']==0?"checked":""?>> 隐藏
                        </label>
                    </div>
                </div>
                <div class="form-actions">
                    <div class="row">
                        <div class="col-md-offset-3 col-md-9">
                            <input type="hidden" id="func[id]" name="func[id]" value="<?php echo $funcInfo['id'];?>"/>
