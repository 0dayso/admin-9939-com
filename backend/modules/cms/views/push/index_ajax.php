			...
			<table  border="1" cellspacing="0" class="d-cell-bos tablay"> 
                ...
                ?>
                 <tr id="line<?php echo $list['id']?>"> 
                    ...
                    <td><?php if($list['status'] == '0'){echo '待推送';}elseif ($list['status']=='1') {echo '已推送';};?></td>
                    <td><?php echo $list['username'];?></td>
                    <td><?php echo date('Y-m-d H:i:s',$list['createtime']);?></td>
                    <td>&nbsp;<a href="/cms/push/edit?nid=<?php echo $list['id']?>" class="d-editor">编辑</a>&nbsp;<a href="javascript:void(0);" onclick="deletes(<?php echo $list['id']?>);" class="d-delet">删除</a></td>
                </tr> 
               <?php
                    }
               ?>
