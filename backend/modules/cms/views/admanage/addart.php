...
<div class="dis-main dis-mainnr">
    <div class="d-titr">
        ...
        <h3>广告内容管理 -- 添加疾病、咨询文章广告</h3>
    </div>

    <form class="edito clinic" action="<?php echo Url::to(['/cms/admanage/insertart']);?>" method="post" id="add_content_form">
