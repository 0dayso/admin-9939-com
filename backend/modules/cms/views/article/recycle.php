...
<!--    <div class="d-titr d-manar"><a href="<?php echo Url::to(['/cms/article/index/']);?>">返回</a><h3>疾病资讯 -- <?php echo Html::encode($this->title);?></h3></div>-->
    ...
    <div class="confi">
        <div class="discov fl">
            <a class="mo" href="<?php echo Url::to(['/cms/article/index/']);?>" data-status="11" data-type="unshow" data-cache="0" style="display:none">未发布</a>
            <a class="mo" href="<?php echo Url::to(['/cms/article/index/']);?>" data-status="99" data-type="show" data-cache="0">已发布</a>
            <a href="<?php echo Url::to(['/cms/article/recycle/']);?>" data-type="unshow" class="cusde">回收站</a>
        </div>
        <div class="totde fr">
            <a href="javascript:void(0);" data-action="<?php echo Url::to([ '/cms/article/delete']); ?>" id="batDelete">批量删除</a>
        ...
        <table  border="1" cellspacing="0" class="d-cell-bos tablay"> 
            <thead>
                <tr style="border-left: 1px solid #ececec;"> 
                    <th class="til_01">全部<input  class="d-asrl" value="unshow_result" type="checkbox" onclick="checkAll(this);"/></th> 
            ...
            ?>
                <tr id="line<?php echo $v['info']['id']; ?>"> 
                    ...
                    <td>
                        ...
                        <a href="javascript:void(0);" onclick="delInfo(this)" data-href="<?php echo Url::to([ '/cms/article/delete', 'id' => $v['info']['id']]); ?>" data-url="<?php echo Url::to([ '/cms/article/delete','id'=>$v['info']['id']]); ?>" data-id="<?php echo $v['info']['id']; ?>" class="d-delet">彻底删除</a>
                    </td>
                </tr> 
            <?php
                }
            }else{
                echo '<tr><td colspan="9">无数据</td></tr>'; 
            }
            ?>
