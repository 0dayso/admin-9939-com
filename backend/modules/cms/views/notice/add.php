...
?>
    ...
    <div class="dis-main dis-mainnr" style="height:900px;">
           ...
           <form class="edito clinic" id="from1" name="from1" action="/cms/notice/add" method="post">
                <div>
                ...
                <div>
                    ...
                    <input type="text" class="txco" id="title" name="title" placeholder="" value="" style="width:640px;">
                </div>
                <div>
                    <label>公告摘要：</label>
                    <textarea class="woro" style="height:70px;width: 770px;" id="description" name="description"></textarea>
                </div>
                <div>
                    <label><span>*</span>公告内容：</label>
                    <script id="content" name="content" id="content" type="text/plain"></script>
                </div>
