...
$this->title = '公告管理';
?>
<div class="dis-bread"><a href="">首页</a>><a href="">内容管理</a>><a href="">公告管理</a></div>
     <div class="dis-main">
           <div class="d-titr d-manar"><a href="/cms/notice/add">添加</a><h3>公告管理</h3></div>
   <form class="disin" action="" method="post"><p>
       <label>ID：</label><input type="text" value="" name="id" id ='id'>
       <label>公告标题：</label><input type="text" value="" name="title" id="title" class="txle">
...
<div class="confi">
    <div class="discov fl">
        ...
        <a class="mo" onclick="changeTab(this);" data-status="2" data-type="nre" >屏蔽</a>
    </div>
    <div class="totde fr"><!--<a href="javascript:void(0);" id="batDelete" data-type>批量删除</a>--></div></div>
			...
			<table  border="1" cellspacing="0" class="d-cell-bos tablay"> 
                  <thead>
                    <tr style="border-left: 1px solid #ececec;"> 
                        <th class="til_01">全部<input  class="d-asrl" type="checkbox" value="all_result_tbody" onclick="checkAll(this);"/></th> 
        ...
        <div class="isshi" style="display:none;" id="nre_result">
            <table  border="1" cellspacing="0" class="d-cell-bos tablay"> 
                  <thead>
                    <tr style="border-left: 1px solid #ececec;"> 
                        <th class="til_01">全部<input  class="d-asrl" type="checkbox" value="nre_result_tbody" onclick="checkAll(this);"/></th> 
                         <th class="til_02">ID</th>
                         <th class="til_03">公告标题 </th> 
                         <th class="til_04">所属客户端</th>
                         <th class="til_05">发布状态</th>  
                ...
                <tbody class="ddf" id="nre_result_tbody">
...
<script src="<?php echo Url::to('@domain/js/cms/notice/manage.js')?>"></script>
<!--时间日期控件-->
<!-- 弹出提示框部分 Start -->
