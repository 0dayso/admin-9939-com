...
<div class="dis-main">
    ...
    <form class="edito" action="<?php echo Url::toRoute('/cms/position/update'); ?>" method="post" id="form">
        <div>
            <label>
                <span>*</span>
                广告位名称：
            ...
            <input type="text" class="txco" id="name" name="name" value="<?php echo $position['name']; ?>">
        </div>
        <div>
            <label>
                <span>*</span>
            ...
            <input type="text" class="txco" id="code" name="code" value="<?php echo $position['code']; ?>">
        </div>
        <div>
            <label>
                <span>*</span>
            ...
            <input type="text" class="txco" id="width" name="width" value="<?php echo $position['width']; ?>">
        </div>
        <div>
            <label>
                <span>*</span>
            ...
            <input type="text" class="txco" id="height" name="height" value="<?php echo $position['height']; ?>">
        </div>
        <div>
            <label>
                <span>*</span>
            ...
            <input type="text" class="txco" id="items" name="items" value="<?php echo $position['items']; ?>">
        </div>
        <div>
            <label>
                备注&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;：
            </label>
            <textarea class="txtar" id="remark" name="remark"><?php echo $position['remark']; ?></textarea>
        </div>
    </form>
