            ...
            foreach ($class_level2 as $key => $val) {
                ...
                <tr depid="<?php echo $val['id']; ?>">
                    ...
                    <td>
                        ...
                        <a href="<?php echo Url::to('/basedata/part/part-level2?id=' . $val['id']); ?>" class="d-find">查看</a>&nbsp;
                        <a href="<?php echo Url::to('/basedata/part/edit-level2?id=' . $val['id']); ?>" class="d-editor">编辑</a>&nbsp;
